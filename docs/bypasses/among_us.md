...
:::note
You don't have to install the game on Steam.
:::
...
### 1. Download the game
1. [Download](https://cdn.openlua.cloud/bypasses/Among%20Us.rar) the game files
2. Extract the contents of the .rar file into a folder. The password for the archive is `openlua.cloud`
